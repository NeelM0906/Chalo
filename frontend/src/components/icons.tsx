...
export const WalkIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M9 20l3-6" />
    <path d="M12 14l5-3-4-3" />
    <path d="M4.2 10.2l7.8 5.6" />
    <path d="m13.8 10.2-4.5 2.1" />
    <path d="m12 20 3-4" />
    <path d="M12 14l-3-4" />
  </svg>
);
  ...
  <svg {...props} viewBox="0 0 80 40" xmlns="http://www.w3.org/2000/svg">
    ...
    <style>{`
      ...
      @keyframes look-around {
        ...
        15% { transform: translateX(3px) translateY(0px); }
        30% { transform: translateX(3px) translateY(0px); }
        45% { transform: translateX(-3px) translateY(0px); }
        60% { transform: translateX(-3px) translateY(0px); }
        75% { transform: translateX(0px) translateY(0px); }
        85% { transform: translateX(0px) translateY(-2px); }
